...
import MedicalCare from "./Medical"
    ...
    return (
        ...
        <section className=" mt-20 mb-20">
            ...
            <div className="flex flex-wrap  justify-center gap-4 py-1 items-center text-center reveal mt-5">
                ...
                <div className="w-64 px-2 py-2 text-xs tracking-wide  border-2 border-white bg-white leading-4  rounded-xl shadow-xl news1 cursor-default">
                    <img className="w-12 m-auto" src={pediatrics} alt="Pediatric image" />
                    <h1 className="font-bold mt-0.5">Pediatrics</h1>
                    <p>Our Pediatric Department provides specialized healthcare for children from infancy to adolescence. From routine vaccinations to treating of children illnesses and developmental support.</p>
                </div>

                <div className="w-64 px-2 py-2 text-xs tracking-wide  border-2 border-white bg-white leading-4  rounded-xl shadow-xl news1 cursor-default">
                    <img className="w-12 m-auto" src={rehab} alt="Brain image" />
                    <h1 className="font-bold mt-0.5">Physiotherapy</h1>
                    <p>Our Physiotherapy department restores mobility and strength after injuries or surgery. We offer personalized physical therapy programs and recovery plans to help you regain strength and vitality.</p>
                </div>
